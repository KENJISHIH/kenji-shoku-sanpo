...
CUISINE_GROUPS = {
    ...
    "ja": {
        ...
        "和食": ["和食", "定食", "ラーメン", "居酒屋"],
        "香港": ["香港料理", "茶餐廳", "氷室", "麺類・ご飯もの", "広東料理", "ワンタン麺"],
    ...
    "en": {
        ...
        "Hong Kong": ["Hong Kong", "Cha chaan teng", "Bing sutt", "Noodles & rice", "Cantonese", "Wonton Noodles"],
...
GLOSSARIES = {
    "ja": [
        ...
        ("建議先訂", "予約推奨"),
        ("/ 人", " / 名"),
        ("套餐附小菜、飯、湯", "セットに小皿・ご飯・スープ付き"),
        ("湯鍋類無附湯", "鍋物はスープなし"),
        ("不接受電話／網路預訂", "電話・ネット予約不可"),
        ("四種小菜無限續加", "小皿4種おかわり自由"),
        ("僅現場點餐", "店頭注文のみ"),
        ("可電話外帶訂餐", "電話でのテイクアウト注文可"),
        ("供餐至", "ラストオーダー "),
        ("有包廂", "個室あり"),
        ("完全預約制", "完全予約制"),
        ("現場候位", "予約不可（先着順）"),
    ...
    "en": [
        ...
        ("刷卡有低消", "minimum charge for credit cards"),
        ...
        ("購物中心內", "shopping mall"),
        ("免費停車場", "free parking"),
        ("路邊獨棟", "freestanding roadside building"),
        ("街角商場", "roadside plaza"),
        ("街角", "corner"),
        ("英文菜單", "English menu"),
        ("日文菜單", "Japanese menu"),
        ...
        ("可線上訂餐", "online ordering available"),
        # San Francisco Chinatown (2026-07 Hon's Wun-Tun House)
        ("鄰近花園角廣場", "near Portsmouth Square"),
        ("華埠", "Chinatown"),
        ("粵語", "Cantonese"),
        ...
        ("建議訂位", "reservations recommended"),
        ("可包吧台", "bar counter available for private booking"),
        ("晚間時段", "evenings only"),
        ("每日", "daily"),
        ...
        ("/ 人", " / person"),
        ("套餐附小菜、飯、湯", "set includes side dishes, rice & soup"),
        ("湯鍋類無附湯", "soup not included with hot-pot dishes"),
        ("不接受電話／網路預訂", "no phone or online reservations"),
        ("四種小菜無限續加", "four side dishes with free refills"),
        ("僅現場點餐", "in-store ordering only"),
        ("可電話外帶訂餐", "phone orders for takeout"),
        ("供餐至", "last order "),
        ("有包廂", "private rooms"),
